/**
 * Generate wedding invitation HTML content
 * @param {string} inviteeName - Name of the invited guest
 * @returns {string} HTML string for the invitation
 */
export function generateInvitationHTML(inviteeName = 'GUEST') {
  return `
    <table
      role="presentation"
      width="100%"
          ...
          >
            <tr>
              <td align="center" style="padding: 0">
                <p
                  style="
                    font-family: 'Playwrite CZ', cursive, Georgia,
            ...
            <tr>
              <td align="center" style="padding: 11px 0 0 0">
                <p
                  style="
              ...
              <td align="center" style="padding: 30px 0">
                ...
                >
                  <tr>
                    <td
                      align="center"
                      style="padding: 0px 29px; height: 33px"
                    >
                      <table
                        role="presentation"
                        border="0"
            ...
            <tr>
              <td align="center" style="padding: 17px 0 2px 0">
                <p
                  style="
